...
<body>
  ...
  <button class="command-complete" id="resetCompliting">Перезагрузить</button>
  <button class="command-complete" id="clearAllCommands">Очистить</button>
  <button class="command-complete" id="buttonView">Список команд</button>

  <div id="executionInfo">
    <h3>Текущая команда</h3>
    <p id="currentCommandHex">Hex: -</p>
    <p id="currentCommandText">Text: -</p>
  </div>

  <table id="opcodeTable" class="hidden-table">
    <tbody>
      <tr class="inf tr1">
